...
const int pin_number[] = {1, 2 ,5, 6 ,8,9, 10, 11, 12,  A0, A1, A4, A2, A5};
...
Smartbin_1::Smartbin_1(int pin1, int pin2, int pin3, int pin4, String bat_status) : pin_Gled(pin1), pin_Rled(pin2), pin_tripn(pin3), pin_echo(pin4), battery(bat_status)
{
  ...
  pinMode(pin_echo, INPUT);
      ...
      for (int set_pin = 0; set_pin < 20; set_pin++)
    {
      pinMode(pin_number[set_pin], INPUT); //change to OUTPUT uncomment the following for loop
    }
